...
const quickReplies = [
  ...
  { content_type: "text", title: "Барааны мэдээлэл", payload: "INFO" },
  { content_type: "text", title: "Захиалга", payload: "ORDER" },
...
async function handleFacebookPayload(senderId: string, payload: string): Promise<boolean> {
  if (payload === "PRICE") {
    await sendFacebookMessage(
      senderId,
      "Сайн байна уу? Манай байгалийн цэвэр сархинагтай зөгийн балны үнэ 39,000 төгрөг (1кг). Та захиалга өгөхийг хүсвэл манай албан ёсны вэбсайтаар зочлоорой.",
    );
    return true;
  }
  ...
  if (payload === "INFO") {
    await sendFacebookMessage(
      senderId,
      "Энэхүү бал нь Өвөрмонголын уулсын олон төрлийн зэрлэг цэцгийн шүүснээс хураасан, 100% байгалийн гаралтай бүтээгдэхүүн юм. Ямар нэгэн үйлдвэрийн боловсруулалтад ороогүй, зөгийн үүрэндээ хэрхэн бүрэлдсэн яг тэрхүү сархинагт хэлбэрээрээ танд очих тул амт чанар, шим тэжээлээ дээд зэргээр хадгалсан байдаг онцлогтой.",
    );
    return true;
  }
  ...
  if (payload === "ORDER") {
    await sendFacebookMessage(
      senderId,
      "Та захиалгаа манай албан ёсны вэбсайтаар дамжуулан маш хялбар бөгөөд найдвартай өгөх боломжтой 👇\nhoney.acnation.net\n\nБанкны QR кодыг уншуулан төлбөрөө хийснээр таны захиалга системд автоматаар бүртгэгдэнэ. Манай систем зөвхөн төлбөр нь амжилттай төлөгдсөн захиалгыг баталгаажуулдаг журамтай.\n\nХүргэлт: Төлбөр баталгаажсан өдрийн маргааш нь хүргэлтийн компани захиалгыг бүртгэж аваад, таны хаяг руу шууд хүргэлтэд гаргадаг. Хүргэж очихоосоо өмнө хүргэлтийн ажилтан тантай утсаар холбогдоно.",
    );
    return true;
  }
  ...
  if (payload === "CONTACT") {
    await sendFacebookMessage(
      senderId,
      "📞 Утас: 9666-5040\n🌐 Вэбсайт: honey.acnation.net\n\nМанай брэндтэй холбоотой санал хүсэлт, асуулт байвал та дээрх утсаар холбогдох, эсвэл энд мессеж үлдээх боломжтой. Бид танд туслахад хэзээд бэлэн.",
    );
    return true;
  }
